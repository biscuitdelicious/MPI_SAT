...
\usepackage{parskip} % Adds space between paragraphs, can help with length slightly
...
\geometry{a4paper, margin=1in} % Set reasonable margins
...
% --- Add Table(s) Summarizing Results ---
% Example: Use booktabs for nicer tables
% \begin{table}[ht]
% \centering
...
% \midrule
% uf20-0995.cnf & DP & DP\_CLAUSE\_LIMIT & 1500.12 & 0 \\ % Example data
% uf20-0995.cnf & DPLL-first & SATISFIABLE & 5.34 & 15 \\
% uf20-0995.cnf & DPLL-random & SATISFIABLE & 6.88 & 22 \\
% uf20-0995.cnf & DPLL-MOMS & SATISFIABLE & 3.12 & 8 \\
% \midrule
% uuf50-01.cnf & DP & DP\_CLAUSE\_LIMIT & 2500.45 & 0 \\ % Example data
% uuf50-01.cnf & DPLL-first & UNSATISFIABLE & 250.76 & 5120 \\
% uuf50-01.cnf & DPLL-random & UNSATISFIABLE & 310.91 & 6800 \\
% uuf50-01.cnf & DPLL-MOMS & UNSATISFIABLE & 180.23 & 3500 \\
% % ... Add more representative rows or averages ...
% \bottomrule
% \end{tabular}
% \end{table}
% Describe the table: "Table \ref{tab:results_summary} shows..."

% --- Add Figure(s) (Optional but good) ---
% Example:
% \begin{figure}[ht]
% \centering
% \includegraphics[width=0.8\textwidth]{dpll_heuristics_comparison.png} % Assume you created this chart
% \caption{Comparison of DPLL Heuristic Performance (Average Decisions on UF20)}
% \label{fig:heuristic_chart}
% \end{figure}
% Describe the figure: "Figure \ref{fig:heuristic_chart} visualizes..."
...
Our experiments vividly illustrate the performance gap between the classic DP algorithm and the DPLL approach. The DP solver's reliance on the resolution rule, while theoretically complete, leads to a practical bottleneck... % (Existing paragraph analyzing DP vs DPLL results seems good, ensure it uses your results)

DPLL, using a backtracking search approach, avoids storing a potentially massive set of intermediate clauses... % (Existing paragraph analyzing heuristics seems good, ensure it uses your specific results and mentions MOMS calculation overhead vs decision reduction)

Limitations of this study include the use of a basic DP implementation lacking sophisticated optimizations like subsumption... % (Existing text seems good)
...
\bibitem{SATLib} % Example citation for SATLib
...
% Add others as needed, e.g., the Autoblocks link if you used its definition directly.

\bibitem{Autoblocks} % Add Autoblocks citation
Autoblocks AI.
Boolean Satisfiability Problem.
Glossary Entry. Accessed [Date Accessed]. % <<< Add Date Accessed!
\url{https://www.autoblocks.ai/glossary/boolean-satisfiability-problem}

\bibitem{Cook1971} % Add Cook's Theorem citation
Stephen A. Cook.
